...
nohup java -jar -Dspring.profiles.active=$IDLE_PROFILE -Djasypt.encryptor.password=$JASYPT_ENCRYPTOR_PASSWORD one-page-resume-BE-0.0.1-SNAPSHOT.jar > nohup.out 2>&1 &
# > nohup.out 2>&1 &
